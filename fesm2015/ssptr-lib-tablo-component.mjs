...
class AppHandmadeSheduleComponent {
    constructor(readerService, activatedRoute) {
        ...
        this.parceParams = (params) => {
            this.viewParams = (Object.assign(Object.assign({}, this.viewParams), { showTime: (isNaN(parseInt(params === null || params === void 0 ? void 0 : params["showTime"])) ? this.viewParams.showTime : parseInt(params === null || params === void 0 ? void 0 : params["showTime"])), rowsOnPage: (isNaN(parseInt(params === null || params === void 0 ? void 0 : params["rowsOnPage"])) ? this.viewParams.rowsOnPage : parseInt(params === null || params === void 0 ? void 0 : params["rowsOnPage"])), progressGrade: (isNaN(parseInt(params === null || params === void 0 ? void 0 : params["progressGrade"])) ? this.viewParams.progressGrade : parseInt(params === null || params === void 0 ? void 0 : params["progressGrade"])) }));
        };
        // fields names from columns$ data 
        this.capToName = (xs) => xs === null || xs === void 0 ? void 0 : xs.map(x => x.name);
        ...
        Object.keys(table[0]).filter(a => GR_CFG[(table[0].TypeId)].exclCol.indexOf(a) < 0)
            .map(colname => { var _a, _b; return ({ name: colname, caption: (_b = (_a = GR_CFG[(table[0].TypeId)].fieldCaptions) === null || _a === void 0 ? void 0 : _a[colname]) !== null && _b !== void 0 ? _b : colname }); });
    ...
    ngOnInit() {
        ...
        //tap( x=> console.log(x) ),
        map(xs => xs.filter(x => { var _a; return !(((_a = x.meta) === null || _a === void 0 ? void 0 : _a[META_PROP_NAME_IS_DISP]) === false); })
            .map(x => {
            var _a, _b;
            return ({
                option: x.option,
                caption: (_a = x.meta) === null || _a === void 0 ? void 0 : _a[META_PROP_NAME_IS_DISPNAME],
                subcaption: (_b = x.meta) === null || _b === void 0 ? void 0 : _b[META_PROP_NAME_IS_DESCR]
            });
        })), switchMap(xs => combineLatest(xs.map(meta => this.readerService.getAllNullT$(meta.option).pipe(filter(x => !!x), map(sdl => sdl ? sdl : []), map(sdl => (Object.assign({ shedule: sdl, pagData: this.tableToPaginating(sdl), columns: this.tableToColumnsN(sdl) }, meta)))))))).pipe(takeUntil(this.destroy$));
    ...
    ngAfterViewInit() {
        ...
        map(shdlsOpt => (Object.assign(Object.assign({}, shdlsOpt), { idx: this.getPaginatingIdx(shdlsOpt.shdls.map(x => x.pagData), shdlsOpt.idx) }))), // abs index to ref index
        //tap( x=> console.log(x)),   // abs index to ref index
        switchMap(shdlsOpt => timer(0, FADE_TIME).pipe(take(2), map(x => (Object.assign(Object.assign({}, shdlsOpt), { st: (x ? FADE_IN : FADE_OUT) })))))).subscribe(shdlsOpt => {
